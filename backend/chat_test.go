...
func TestReadOnlyCommandGuardCorpus(t *testing.T) {
	valid := []planStep{{Executable: "uptime"}, {Executable: "free", Args: []string{"-h"}}, {Executable: "df", Args: []string{"-P"}}, {Executable: "ps", Args: []string{"-eo", "pid,comm,pcpu,pmem"}}, {Executable: "uname", Args: []string{"-r"}}, {Executable: "ss", Args: []string{"-tulpn"}}, {Executable: "ip", Args: []string{"-br", "a"}}, {Executable: "systemctl", Args: []string{"is-active", "nginx.service"}}, {Executable: "systemctl", Args: []string{"list-units", "--failed"}}, {Executable: "docker", Args: []string{"ps"}}, {Executable: "du", Args: []string{"-sh", "--", "/var/backups/nirvaya data"}}, {Executable: "du", Args: []string{"-s", "--block-size=1", "--", "/backup/archive"}}, {Executable: "find", Args: []string{"/var/backups", "-maxdepth", "6", "-type", "d", "-iname", "*nirvaya backup*"}}, {Executable: "ls", Args: []string{"-la", "--", "/srv/apps"}}, {Executable: "stat", Args: []string{"--", "/opt/app"}}}
